    ...
    <StaticQuery
      ...
      render={data => (
        <StyledAppBar spacing={spacing}>
          <SlideInFade enterTimeout={enterTimeout.et1}>
            <Typography>About</Typography>
          </SlideInFade>
          <SlideInFade enterTimeout={enterTimeout.et2}>
            <Typography>Experience</Typography>
          </SlideInFade>
          <SlideInFade enterTimeout={enterTimeout.et3}>
            <Typography>Work</Typography>
          </SlideInFade>
          <SlideInFade enterTimeout={enterTimeout.et4}>
            <Typography>Contact</Typography>
          </SlideInFade>
          <SlideInFade enterTimeout={enterTimeout.et5}>
